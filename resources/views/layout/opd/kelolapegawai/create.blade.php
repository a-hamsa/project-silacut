        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-warning  alert-dismissible fade show" role="alert">
                    ...
                    <p>Mohon pastikan bahwa seluruh data telah diisi dengan lengkap sebelum disimpan. Hal ini penting untuk memastikan kelengkapan informasi</p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <form method="POST" action="{{ route('storepegawaiopd') }}">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('txtid') is-invalid @enderror" placeholder="Masukkan NIP" name="txtid" id="txtid" value="{{ old('txtid') }}">
                                    @error('txtid')
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('txtname') is-invalid @enderror" placeholder="Masukkan Nama" name="txtname" id="txtname" value="{{ old('txtname') }}">
                                    @error('txtname')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('txtbirthplace') is-invalid @enderror" placeholder="Tempat Lahir" name="txtbirthplace" id="txtbirthplace" value="{{ old('txtbirthplace') }}">
                                    @error('txtbirthplace')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-12" style="margin-bottom:15px;">
                                ...
                                <div class="input-group">
                                    <select class="form-select @error('txtgender') is-invalid @enderror" aria-label="Default select example" id="txtgender" name="txtgender">
                            ...
                            <div class="col-md-12" style="margin-bottom:15px;">
                                ...
                                <div class="input-group">
                                    <select class="form-select @error('txtposition') is-invalid @enderror" aria-label="Default select example" name="txtposition">
