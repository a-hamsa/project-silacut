                    ...
                    success: function(response) {
                        ...
                        $('#data_pegawai').DataTable({
                            columnDefs: [{
                                ...
                                {
                                    targets: [3], // Column index for Id_Jenis_Cuti
                                ...
                                {
                                    targets: [10], // Column index for Verifikasi
                                    render: function(data, type, row) {
                                        if (data === true) {
                                            ...
                                            return '<span class="badge text-bg-warning">Masih diproses</span>';
                                        }
                                    }
                                }
                            ],
                            ...
                            columns: [{
                                    ...
                                    render: function(data, type, row, meta) {
                                        return meta.row +
                                        1; // This renders the row index starting from 1
                                    }
                                },
                                {
                                    data: "NIP"
                                ...
                                {
                                    data: "Id_Jenis_Cuti" // This will be mapped in columnDefs
                                },
                                {
                                    data: null,
                                    render: function(data, type, row) {
                                ...
                                {
                                    data: "Verifikasi" // This is handled in columnDefs
                                }
                            ],
                            scrollX: true,
                            scrollY: 300,
