...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/logomorowali.png" rel="icon">
  <link href="assets/img/logomorowali.png" rel="apple-touch-icon">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="#" class="logo d-flex align-items-center">
        <img src="assets/img/silacut.png" alt="" style="justify-content:center;">
