...
class Data_Pegawai extends Controller
{
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('kelolapegawai')->with('success', 'Data berhasil di update');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kelolapegawai')->with('success', 'Data berhasil ditambahkan');
    }
    ...
    {    
        ...
        $tb_pegawai->delete();
        return redirect()->route('kelolapegawai')->with('success', 'Data berhasil dihapus');
    }
}
